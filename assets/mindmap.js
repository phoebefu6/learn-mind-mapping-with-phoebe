...
(function () {
  ...
  var C_ACCENT = theme("--indigo", "#B85015");        // session fill + trunk
  var C_DEEP   = theme("--indigo-deep", "#1E4A36");   // root fill
  var C_SOFT   = theme("--indigo-soft", "#B9D8C6");   // concept border
  var C_TINT   = theme("--indigo-50", "#EAF4EE");     // concept fill
  var C_INK    = theme("--ink", "#14261D");           // concept text
  var C_FAINT  = theme("--faint", "#CFDCD4");         // twig edges
