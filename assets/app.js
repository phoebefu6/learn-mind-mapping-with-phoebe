/* learn-mind-mapping-with-phoebe - shared page behavior
...
(function () {
  ...
  if (crumb && mastheadWrap) {
    ...
    if (m) {
      ...
      var pages = ["01-one-centre-many-branches.html", "02-keywords-and-the-branch-budget.html", "03-mind-map-concept-map-or-list.html", "04-the-map-bench.html", "05-maps-as-text.html", "06-maps-that-do-work.html"];
...
(function () {
  "use strict";
  var PASSPORT_KEY = "lwp-passport:mind-mapping";
